...
| at0100 | Per type > Per episode | Status | DV_CODED_TEXT |
| at0030 | Per type > Per episode | Pattern | DV_CODED_TEXT / DV_TEXT |
| at0065 | Per type > Per episode | Typical use | DV_QUANTITY |
| at0023 | Per type > Per episode | Typical frequency | DV_QUANTITY |
...
|------|----------------|------|--------------------|
| at0026 | Per type > Per episode | Episode details | openEHR-EHR-CLUSTER.cessation_attempts(-[a-zA-Z0-9_]+)*.v1 / openEHR-EHR-CLUSTER.cessation_attempts(-[a-zA-Z0-9_]+)*.v0 |
