...
| at0019 | Physical location | Location onset | DV_DATE_TIME |
| at0025 | Physical location | Location category | DV_TEXT |
| at0022 | Physical location | Ward | DV_TEXT |
| at0023 | Physical location | Room | DV_TEXT |
| at0024 | Physical location | Bed | DV_TEXT |
| at0020 | Physical location | Location end | DV_DATE_TIME |
...
| at0017 | Physical location | Location | openEHR-EHR-CLUSTER.address(-[a-zA-Z0-9_]+)*.v1 / openEHR-EHR-CLUSTER.organisation(-[a-zA-Z0-9_]+)*.v1 |
