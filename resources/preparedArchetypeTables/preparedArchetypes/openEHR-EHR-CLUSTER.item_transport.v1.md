...
| at0015 | Transportation step | Transport sequence | DV_COUNT / DV_TEXT |
...
| at0026 | Transportation step | Transport step detail | openEHR-EHR-CLUSTER.item_transport(-[a-zA-Z0-9_]+)*.v1 |
