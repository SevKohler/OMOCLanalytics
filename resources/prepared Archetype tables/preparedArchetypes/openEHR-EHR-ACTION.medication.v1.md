...
| at0147 | Route | DV_TEXT |
| at0141 | Body site | DV_TEXT |
| at0143 | Administration method | DV_TEXT |
...
| at0142 | Structured body site | openEHR-EHR-CLUSTER.anatomical_location(-[a-zA-Z0-9_]+)*.v1 / openEHR-EHR-CLUSTER.anatomical_location_circle(-[a-zA-Z0-9_]+)*.v1 / openEHR-EHR-CLUSTER.anatomical_location_relative(-[a-zA-Z0-9_]+)*.v2 |
| at0144 | Administration device | openEHR-EHR-CLUSTER.device(-[a-zA-Z0-9_]+)*.v1 |
