...
| at0094 | Study name | DV_TEXT |
| at0095 | Study identifier | DV_IDENTIFIER / DV_TEXT |
| at0096 | Study date | DV_DATE_TIME |
| at0097 | Study end point | DV_TEXT / DV_URI |
| at0031 | Receiver order identifier | DV_IDENTIFIER / DV_CODED_TEXT |
| at0028 | Requester order identifier | DV_IDENTIFIER / DV_TEXT |
| at0029 | Examination requested name | DV_TEXT |
...
| at0067 | Comparison series details | openEHR-EHR-CLUSTER.imaging_series(-[a-zA-Z0-9_]+)*.v0 / openEHR-EHR-CLUSTER.imaging_series(-[a-zA-Z0-9_]+)*.v1 |
| at0030 | Requester | openEHR-EHR-CLUSTER.organisation(-[a-zA-Z0-9_]+)*.v0 / openEHR-EHR-CLUSTER.organisation(-[a-zA-Z0-9_]+)*.v1 / openEHR-EHR-CLUSTER.person(-[a-zA-Z0-9_]+)*.v1 |
